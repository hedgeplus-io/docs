            ...
            <div>
              ...
              <nav className='sidebar__nav mt-8 flex-1 px-4 space-y-1'>
                <div className='hidden md:block'>
                  ...
                  <div>
                    <a href={`https://www.hedgeplus.io/docs/`} className="pl-2 flex text-gray hover:text-docblue text-lg py-2 transition ease-in-out duration-150 w-full font-Catamaran">
